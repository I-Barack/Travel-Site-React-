...
const Navbar = () => {
  ...
  return (
    <div className='w-full flex justify-between items-center h-20 px-4 absolute z-10 text-white'>
      ...
      <div onClick={handleNav} className={nav ? 'absolute text-black left-0 top-0 w-full bg-gray-100/90 px-4 py-6 flex flex-col' : 'absolute left-[-100%] top-0 w-full bg-gray-100/90 px-4 py-6 flex flex-col'}>
        <ul>
          <h1>BEACHES.</h1>
